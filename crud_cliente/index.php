                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="apellido-p" placeholder="Apellido paterno">
                                    <input type="text" class="form-control mb-3" name="apellido-m" placeholder="Apellido materno">
                                    ...
                                    <input type="date" class="form-control mb-3" name="nacimiento" placeholder="Fecha de nacimiento">                                    
